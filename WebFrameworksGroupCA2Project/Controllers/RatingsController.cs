...
namespace WebFrameworksGroupCA2Project.Controllers
{
    ...
    public class RatingsController : Controller
    {
        ...
        public RatingsController(WebFrameworksGroupCA2ProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,UserRating,Comment,UserId,SongId")] Rating rating)
        {
