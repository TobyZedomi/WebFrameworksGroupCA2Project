...
namespace WebFrameworksGroupCA2Project.Controllers
{
    ...
    public class ShoppingCartsController : Controller
    {
        ...
        public ShoppingCartsController(WebFrameworksGroupCA2ProjectContext context)
        {
            _context = context;
        }
        ...
        {
            var webFrameworksGroupCA2ProjectContext = _context.ShoppingCart.Include(s => s.AppUser);
        ...
        public async Task<IActionResult> Create([Bind("Id,IsDeleted,UserId")] ShoppingCart shoppingCart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IsDeleted,UserId")] ShoppingCart shoppingCart)
        {
